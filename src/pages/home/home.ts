...
import { BestScoreManagerProvider } from '../../providers/best-score-manager/best-score-manager';
...
export class HomePage {
  ...
  constructor(private bestScoreService: BestScoreManagerProvider,public navCtrl: NavController) {
